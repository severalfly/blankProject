...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 ...
	 private int getAllNeighbors(List<Integer> passed, List<Integer> inList)
	 {
		 if(inList.size() <= 0)
		 {
			 return 0;
		 ...
		 for(int i: inList)
		 {
			 ...
			 passed.add(i);
			 result += getAllNeighbors(passed,getNeighbors(i));
		 }
		 return result;
	 }
	 private int getAllInNeighbors(List<Integer> passed,List<Integer> inList)
	 {
		 if(inList.size() <= 0)
		 {
			 return 0;
		 ...
		 for(int i: inList)
		 {
			 ...
			 passed.add(i);
			 result += getAllInNeighbors(passed,getInNeighbors(i));
		 }
		 return result;
	 }
